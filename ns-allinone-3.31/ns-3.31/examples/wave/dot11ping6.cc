...
main (int argc, char *argv[]) {
    ...
    wifiPhy.EnablePcap ("dot11ping6", devices);
    ...
    wifiPhy.EnableAsciiAll (ascii.CreateFileStream("dot11ping6.tr"));
    
    AnimationInterface anim("dot11ping6.xml");
    anim.SetMobilityPollInterval(Time("0.25s"));
