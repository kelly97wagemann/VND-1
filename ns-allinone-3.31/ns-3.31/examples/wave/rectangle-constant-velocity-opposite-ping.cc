...
positionAlloc->Add (Vector (20.0, 50, 0.0));
...
/////////////
    ...
    wifiPhy.EnablePcap ("rectangle-constant-velocity-opposite-ping", devices);
...
AnimationInterface anim("rectangle-constant-velocity-opposite-ping.xml");
