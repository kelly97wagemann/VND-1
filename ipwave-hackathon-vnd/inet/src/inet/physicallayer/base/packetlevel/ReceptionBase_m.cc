//
// Generated file, do not edit! Created by nedtool 5.4 from inet/physicallayer/base/packetlevel/ReceptionBase.msg.
//
...
const char *ReceptionBaseDescriptor::getFieldTypeString(int field) const
{
    ...
    static const char *fieldTypeStrings[] = {
        ...
        "inet::EulerAngles",    // FIELD_startOrientation
        "omnetpp::simtime_t",    // FIELD_endTime
        "inet::Coord",    // FIELD_endPosition
        "inet::EulerAngles",    // FIELD_endOrientation
...
const char *ReceptionBaseDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        ...
        case FIELD_startOrientation: return omnetpp::opp_typename(typeid(EulerAngles));
        case FIELD_endPosition: return omnetpp::opp_typename(typeid(Coord));
        case FIELD_endOrientation: return omnetpp::opp_typename(typeid(EulerAngles));
