...
//    BAM
  ...
  public:
    ...
    //XIANG ZHONG
    Ptr<const Chunk> getNewContent() const { return content; } // only for class descriptor
//    ---------------------
    explicit Packet(const char *name = nullptr, short kind = 0);
    Packet(const char *name, const Ptr<const Chunk>& content);
    //XIANG ZHONG
    Packet(const char *name, short kind, const Ptr<const Chunk>& content);
//    -------------------------------
...
//    {
////        frontOffset = frontIterator.getPosition();
//        return frontIterator.getPosition(); }
...
//    {
////       backOffset = getTotalLength() - backIterator.getPosition();
//        return backOffset;
//    }
...
//    void setBackOffset(b backOffset)
//    {
...
//    {
////        dataLength =getTotalLength() - frontIterator.getPosition() - backIterator.getPosition();
//        return dataLength;
//
//    }
//    virtual void setDataLength(b dataLength);
    /**
