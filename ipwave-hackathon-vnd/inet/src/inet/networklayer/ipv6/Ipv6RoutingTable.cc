...
{
    std::cout <<"Prefix Length -> " <<prefixLength <<std::endl;
...
{
    std::cout <<"----- configureInterfaceForIpv6 " <<std::endl;
...
{
    std::cout <<"----> add or updateOnLinkPrefix!" <<std::endl;
...
void Ipv6RoutingTable::addStaticRoute(const Ipv6Address& destPrefix, int prefixLength,
        ...
        int metric)
{
    std::cout << "addStaticRoute !!! "<<std::endl;
    // create route object
...
{
    // create route object
    std::cout <<"-----> Add Default Route! " <<std::endl;
