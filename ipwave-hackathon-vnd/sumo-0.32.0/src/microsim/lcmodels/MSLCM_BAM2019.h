...
/****************************************************************************/
#ifndef MSLCM_BAM2019_h
#define MSLCM_BAM2019_h
 ...
 */
class MSLCM_BAM2019 : public MSAbstractLaneChangeModel {
public:
    ...
    MSLCM_BAM2019(MSVehicle& v);

    virtual ~MSLCM_BAM2019();
...
protected:
    ...
    int checkBlocking(const MSLane& neighLane, double& latDist, double& maneuverDist, int laneOffset,
                      ...
                      double gapFactor = 0,
                      int* retBlockedFully = 0); //BAM Comment
