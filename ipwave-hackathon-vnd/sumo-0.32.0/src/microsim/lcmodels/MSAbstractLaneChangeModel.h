...
public:
    ...
    public:
        ...
        void* informNeighLeader(void* info, MSVehicle* sender) {
            std::cout <<" xxxxxxxxxx >void* informNeighLeader(void* info, MSVehicle* sender) "<<std::endl;
        ...
        void* informNeighFollower(void* info, MSVehicle* sender) {
            std::cout <<" xxxxxxxx >         void* informNeighFollower(void* info, MSVehicle* sender) " << std::endl;
