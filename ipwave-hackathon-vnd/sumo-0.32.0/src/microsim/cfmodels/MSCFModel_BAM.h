...
/****************************************************************************/
#ifndef MSCFModel_BAM_h
#define MSCFModel_BAM_h
 ...
 * @see MSCFModel
 */
class MSCFModel_BAM : public MSCFModel_KraussOrig1 {
public:
    /** @brief Constructor
     ...
     */
    MSCFModel_BAM(const MSVehicleType* vtype, double accel, double decel,
