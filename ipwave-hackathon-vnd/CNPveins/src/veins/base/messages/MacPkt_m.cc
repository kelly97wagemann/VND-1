...
inet::MacAddress& MacPkt::getDestAddr()
{
    return this->destAddr;
}

void MacPkt::setDestAddr(const inet::MacAddress& destAddr)
{
    this->destAddr = destAddr;
}

inet::MacAddress& MacPkt::getSrcAddr()
{
    return this->srcAddr;
}

void MacPkt::setSrcAddr(const inet::MacAddress& srcAddr)
{
...
const char *MacPktDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        ...
        case 1: return omnetpp::opp_typename(typeid(inet::MacAddress));
        default: return nullptr;
    };
}
