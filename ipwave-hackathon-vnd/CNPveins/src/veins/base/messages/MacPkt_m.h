...
/**
 * Class generated from <tt>veins/base/messages/MacPkt.msg:37</tt> by nedtool.
 * <pre>
 ...
 * packet MacPkt
 * {
 *     inet::MacAddress destAddr; // destination mac address
 *     inet::MacAddress srcAddr;  // source mac address
...
{
  protected:
    inet::MacAddress destAddr;
    inet::MacAddress srcAddr;
    long sequenceId;
  ...
  public:
    ...
    virtual inet::MacAddress& getDestAddr();
    virtual const inet::MacAddress& getDestAddr() const {return const_cast<MacPkt*>(this)->getDestAddr();}
    virtual void setDestAddr(const inet::MacAddress& destAddr);
    virtual inet::MacAddress& getSrcAddr();
    virtual const inet::MacAddress& getSrcAddr() const {return const_cast<MacPkt*>(this)->getSrcAddr();}
    virtual void setSrcAddr(const inet::MacAddress& srcAddr);
