...
const char * BasicSafetyMessage::getSenderID() const
{
    return this->senderID.c_str();
}

void BasicSafetyMessage::setSenderID(const char * senderID)
{
    this->senderID = senderID;
}

double BasicSafetyMessage::getSendingSpeed() const
{
    return this->sendingSpeed;
}

void BasicSafetyMessage::setSendingSpeed(double sendingSpeed)
{
    this->sendingSpeed = sendingSpeed;
}

const char * BasicSafetyMessage::getCurrentLane() const
{
    return this->CurrentLane.c_str();
}

void BasicSafetyMessage::setCurrentLane(const char * CurrentLane)
{
    this->CurrentLane = CurrentLane;
}

const char * BasicSafetyMessage::getHeadingLane() const
{
    return this->headingLane.c_str();
}

void BasicSafetyMessage::setHeadingLane(const char * headingLane)
{
    this->headingLane = headingLane;
}

double BasicSafetyMessage::getTheta() const
{
    return this->theta;
}

void BasicSafetyMessage::setTheta(double theta)
{
    this->theta = theta;
}

bool BasicSafetyMessage::getIsrsu() const
{
    return this->isrsu;
}

void BasicSafetyMessage::setIsrsu(bool isrsu)
{
    this->isrsu = isrsu;
}
