...
//              BAM
                ...
                TraCICoord ReturnSumoCurrentposition(Coord CurPos);
                double getLeaderPosDistance();
                std::string getLeadeID(std::string vid, double dst);
                double getLeaderdst(std::string vid, double dst);
//              BAM
